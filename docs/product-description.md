...
- **UsageEvent** {id, orgId, ts, units, idempotencyKey, source='api'} _(append-only)_
- **UsageCounter** {orgId, periodKey(YYYY-MM), usedUnits, remainingUnits} _(cached from Redis; recomputable)_
